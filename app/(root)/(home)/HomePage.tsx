...
const HomePage = () => {
    ...
    return (
        <>
            ...
            <div ref={ref2} className="bg-background mt-[20px] relative h-[100px] w-full overflow-hidden mb-[150px]">
                ...
                <div className='absolute top-0 bottom-0 flex justify-center items-center left-0 right-0 bg-black/90'>
                    <h3 className='title mx-auto md:text-[50px] text-[30px] font-extrabold w-full text-center px-4'>Our Latest Works</h3>
                </div>
            </div>
